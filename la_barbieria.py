        ...
        while True:
            ...
            if opcion == 1:
                while True:
                    ...
                    if operacion == 4:
                        ...
                        tintura_numero_uno = input('Ingrese numero de tintura (EJ: TINTURA 7 o TINTURA 9.2):\n')
                        cantidad_tintura_uno = input('Ingrese cantidad de tintura a utilizar (EJ: 45):\n')
                        tintura_numero_dos = input('Ingrese numero de segunda tintura a utilizar (EJ: TINTURA 7 o TINTURA 9.2):\n')
                    ...
                    if operacion == 6:
                        nombre_cliente, telefono_cliente, precio = datos_cliente()
                        cantidad_queratina = input('Ingrese cantidad de queratina a utilizar (EJ: 100):\n')
                    ...
                    if operacion == 7:
                        nombre_cliente, telefono_cliente, precio = datos_cliente()
                        cantidad_alisado = input('Ingrese cantidad de alisado a utilizar (EJ: 100):\n')
                    ...
                    if operacion == 8:
                        nombre_cliente, telefono_cliente, precio = datos_cliente()
                        cantidad_plastificado = input('Ingrese cantidad de plastificado a utilizar (EJ: 100):\n')
                    ...
                    if operacion == 9:
                        nombre_cliente, telefono_cliente, precio = datos_cliente()
                        cantidad_biomolecular = input('Ingrese cantidad de biomolecular a utilizar (EJ: 100):\n')
                        writer.writerow({'PELUQUERIA_OPERACION':'ALISADO','NOMBRE_CLIENTE':nombre_cliente.upper(),
                    ...
                    if operacion == 10:
                        nombre_cliente, telefono_cliente, precio = datos_cliente()
                        cantidad_argan = input('Ingrese cantidad de argan a utilizar (EJ: 100):\n')
                        writer.writerow({'PELUQUERIA_OPERACION':'ALISADO','NOMBRE_CLIENTE':nombre_cliente.upper(),
                    ...
                    if operacion == 11:
                        nombre_cliente, telefono_cliente, precio = datos_cliente()
                        cantidad_espejo = input('Ingrese cantidad de espejo a utilizar (EJ: 100):\n')
                        writer.writerow({'PELUQUERIA_OPERACION':'ALISADO','NOMBRE_CLIENTE':nombre_cliente.upper(),
                    ...
                    if operacion == 12:
                        nombre_cliente, telefono_cliente, precio = datos_cliente()
                        cantidad_biotina = input('Ingrese cantidad de biotina a utilizar (EJ: 100):\n')
                        writer.writerow({'PELUQUERIA_OPERACION':'ALISADO','NOMBRE_CLIENTE':nombre_cliente.upper(),
                    ...
                    if operacion == 13:
                        nombre_cliente, telefono_cliente, precio = datos_cliente()
                        cantidad_botox = input('Ingrese cantidad de botox a utilizar (EJ: 100):\n')
                        writer.writerow({'PELUQUERIA_OPERACION':'ALISADO','NOMBRE_CLIENTE':nombre_cliente.upper(),
                    ...
                    if operacion == 14:
                        nombre_cliente, telefono_cliente, precio = datos_cliente()
                        cantidad_lifting = input('Ingrese cantidad de lifting a utilizar (EJ: 100):\n')
                        writer.writerow({'PELUQUERIA_OPERACION':'ALISADO','NOMBRE_CLIENTE':nombre_cliente.upper(),
            ...
            if opcion == 2:
                while True:                
                    ...
                    try:
                        precio_stock = int(input('Ingrese precio producto (EJ: 500):\n'))
                    except:
...
def reflejo():
    reflejo_uno = input('Ingrese el numero del primer reflejo (EJ: REFLEJO 3):\n')
    cantidad_reflejo_uno = input('Ingrese cantidad de reflejo a utilizar (EJ: 20):\n')
    reflejo_dos = input('Ingrese el numero del segundo reflejo (EJ: REFLEJO 3):\n')
    cantidad_reflejo_dos = input('Ingrese cantidad de reflejo a utilizar (EJ: 20):\n')
    reflejo_tres = input('Ingrese el numero del tercer reflejo (EJ: REFLEJO 3):\n')
