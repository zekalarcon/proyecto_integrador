...
Descripcion:
Programa para consultar transacciones y stock de la peluqueria
'''
        ...
        while True:
            ...
            if opcion == 3:
                ...
                cliente_nombre = input(
                    'Ingrese nombre y apellido cliente (EJ: JUAN PEREZ):\n').upper()
                datos = []
                for i in range(len_reader):
                    row = reader[i]
            ...
            if opcion == 4:
                ...
                print(
                    f'El stock de {opcion} es: {suma_producto_stock - tintura_suma} grs.')
            ...
            if opcion == 5:
                ...
                print(
                    f'El stock del {opcion} es: {suma_producto_stock - reflejo_suma} grs.')
            ...
            if opcion == 6:
                ...
                print(
                    f'El stock de {opcion} es: {suma_producto_stock - oxigenada_suma} grs.')
            ...
            if opcion == 7:
                ...
                print(
                    f'La cantidad de polvo decolorante en stock es: {suma_producto_stock - polvo_suma} grs.')
            ...
            if opcion == 8:
                ...
                print(
                    f'La cantidad de queratina en stock es: {suma_producto_stock - queratina_suma} grs.')
            ...
            if opcion == 9:
                ...
                print(
                    f'La cantidad de alisado en stock es: {suma_producto_stock - alisado_suma} grs.')
            ...
            if opcion == 10:
                ...
                print(
                    f'La cantidad de plastificado en stock es: {suma_producto_stock - plastificado_suma} grs.')
            ...
            if opcion == 11:
                ...
                print(
                    f'La cantidad de biomolecular en stock es: {suma_producto_stock - biomolecular_suma} grs.')
            ...
            if opcion == 12:
                ...
                print(
                    f'La cantidad de argan en stock es: {suma_producto_stock - argan_suma} grs.')
            ...
            if opcion == 13:
                ...
                print(
                    f'La cantidad de espejo en stock es: {suma_producto_stock - espejo_suma} grs.')
            ...
            if opcion == 14:
                ...
                print(
                    f'La cantidad de biotina en stock es: {suma_producto_stock - biotina_suma} grs.')
            ...
            if opcion == 15:
                ...
                print(
                    f'La cantidad de botox en stock es: {suma_producto_stock - botox_suma} grs.')
